...
const PLATFORM_COLORS = {
  ...
  'Craigslist': 'bg-green-500/20 text-green-400 border-green-500/30',
  'OfferUp': 'bg-pink-500/20 text-pink-400 border-pink-500/30',
}
    ...
    <div className="space-y-8">
      ...
      <div>
        <h1 className="text-3xl font-display font-bold neon-text tracking-wide">
          OptiFinder — Market Radar
        </h1>
        <p className="text-gray-400 mt-1 font-mono text-sm">
          Scan marketplaces for underpriced rigs with flip potential
        </p>
      </div>

      {/* Niche Scanner */}
      <section className="bg-surface border border-border rounded-xl p-6">
        <h2 className="font-display text-lg text-neon mb-4 tracking-wide">Niche Scanner</h2>
              ...
              <div className="flex-1 flex items-center gap-3">
                <div className="flex-1 space-y-1">
                  <div className="flex items-center gap-2">
                    <span className="text-[10px] text-cyan-400 uppercase tracking-wider w-14">Demand</span>
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-[10px] text-gray-500 uppercase tracking-wider w-14">Supply</span>
                    <div className="flex-1 h-2 bg-surface-lighter rounded-full overflow-hidden">
                      <div
      ...
      <div className="flex flex-wrap items-center gap-6">
        ...
        <label className="flex items-center gap-3 cursor-pointer select-none">
          ...
          <div>
            <span className="text-sm text-gray-200 font-display">Auto-Scan</span>
            <span className="text-xs text-gray-500 ml-2 font-mono">
              scan marketplaces every 15 min for deals
            </span>
          </div>
        </label>
        ...
        <div className="ml-auto flex items-center gap-3">
          ...
          >
            ...
            <option value="bones">Sort: Good Bones</option>
            <option value="days">Sort: Days Listed</option>
          </select>
        </div>
      </div>
        ...
        {filteredListings.map((listing) => (
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              >
                <span className="text-[10px] text-gray-400 uppercase tracking-wider">Bones</span>
            ...
            <div className="bg-neon-green/5 border border-neon-green/20 rounded-lg px-3 py-2 mb-3">
              <span className="text-[10px] text-neon-green uppercase tracking-wider">Upgrade Path</span>
      ...
      {/* Profit Calculator */}
      <section className="bg-surface border border-border rounded-xl p-6">
        <h2 className="font-display text-lg text-neon mb-4 tracking-wide">Profit Calculator</h2>
        <div className="flex flex-wrap items-end gap-4">
          <div className="space-y-1">
            <label className="text-xs text-gray-500 font-mono uppercase tracking-wider">Buy Price</label>
          ...
          <div className="space-y-1">
            <label className="text-xs text-gray-500 font-mono uppercase tracking-wider">Upgrade Cost</label>
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 font-mono text-sm">$</span>
              <input
                type="number"
          ...
          <div className="space-y-1">
            <label className="text-xs text-gray-500 font-mono uppercase tracking-wider">Sell Price</label>
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 font-mono text-sm">$</span>
              <input
                type="number"
          ...
          <div className="flex items-center gap-6 ml-4 pb-0.5">
            <div>
              <div className="text-[10px] text-gray-500 uppercase tracking-wider font-mono">Profit</div>
              <div
