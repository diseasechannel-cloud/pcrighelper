...
const moduleCards = [
  {
    key: "build",
    title: "Сборка",
    desc: "Собери ПК мечты с проверкой совместимости в реальном времени",
    stat: "1 284 сборки на этой неделе",
    cta: "Начать сборку",
    to: "/build",
    icon: (
  ...
  },
  {
    key: "benchmark",
    title: "Бенчмарк",
    desc: "Стресс-тест железа и подробные оценки производительности",
    stat: "9.4М результатов",
    cta: "Запустить тест",
    to: "/benchmark",
    icon: (
      <svg className="size-8" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    key: "compare",
    title: "Сравнение",
    desc: "Характеристики и бенчмарки двух компонентов бок о бок",
    stat: "326 видеокарт в базе",
    cta: "Сравнить",
    to: "/compare",
    icon: (
      <svg className="size-8" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    key: "market",
    title: "Маркет",
    desc: "Покупай, продавай и перепродавай комплектующие по лучшим ценам",
    stat: "3.4М₽ торгов сегодня",
    cta: "Открыть маркет",
    to: "/market",
    icon: (
      <svg className="size-8" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    <div className="pcb-bg min-h-screen pb-20">
      ...
      <section className="relative flex flex-col items-center justify-center px-4 pt-24 pb-16 text-center">
        ...
        <p className="mt-4 max-w-xl font-mono text-lg text-gray-400 sm:text-xl">
          Апгрейд ПК&nbsp;&mdash; Сборка, Бенчмарки, Сравнение, Флип
        </p>
        ...
        <div className="neon-glow mt-10 flex w-full max-w-2xl items-center gap-3 rounded-xl border border-neon/30 bg-surface-light px-5 py-3">
          ...
          <input
            ...
            placeholder="Поиск компонентов, сборок, бенчмарков..."
            ...
            >
              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="font-mono text-xs text-gray-500">от {build.user}</p>
                </div>
              ...
              <div className="mt-5 flex items-center justify-between border-t border-border pt-4">
                <div className="flex flex-col gap-1">
                  ...
                  <span className="font-mono text-[10px] text-gray-600">{build.votes} голосов</span>
                </div>
                <Link
                  to={`/builds/${build.id}`}
